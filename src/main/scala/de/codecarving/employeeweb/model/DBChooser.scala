...
trait DBChooser[T <: Boot] {
  ...
  db match {
    ...
    case H2DB =>
      ...
      import de.codecarving.employeeweb.persistence.h2.{ BackendEntry, BackendEntryCounter }
      ...
      Schemifier.schemify(true, Schemifier.infoF _, BackendEntry, BackendEntryCounter)
